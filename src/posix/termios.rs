...
// Mac OS needs special logic for setting arbitrary baud rates, but that isn't done here. Here we
// only ensure that a sane default is used (9600 baud) and defer the additional custom logic to
// elsewhere.
